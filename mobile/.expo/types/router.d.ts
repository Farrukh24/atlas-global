...
declare module "expo-router" {
  ...
  // prettier-ignore
  type StaticRoutes = `/` | `/(app)/(tabs)/earnings` | `/earnings` | `/(app)/(tabs)/` | `/(app)/(tabs)` | `/(app)/(tabs)/my-loads` | `/my-loads` | `/(app)/(tabs)/profile` | `/profile` | `/(auth)/login` | `/login` | `/(auth)/register` | `/register`;
  // prettier-ignore
  type DynamicRoutes<T extends string> = `/(app)/load/tracking/${SingleRoutePart<T>}` | `/load/tracking/${SingleRoutePart<T>}` | `/(app)/load/${SingleRoutePart<T>}` | `/load/${SingleRoutePart<T>}`;
  // prettier-ignore
  type DynamicRouteTemplate = `/(app)/load/tracking/[id]` | `/(app)/load/[id]`;
